 ...
 */
const WsSubscribeProjectEntryChangesRpc = Rpc.make(WS_METHODS.subscribeProjectEntryChanges, {
  payload: ProjectListEntriesInput,
 ...
 */
const WsSubscribeProjectFileChangesRpc = Rpc.make(WS_METHODS.subscribeProjectFileChanges, {
  payload: ProjectReadFileInput,
